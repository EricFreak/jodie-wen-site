...
- 2026-08-06（四轮）：个人品牌 logo 上线（Lovart 出图，已程序化去除假透明棋盘格底、只裁边距）：导航栏品牌位换为完整横版 logo（JW + Dr. Jodie Wen + Author & Commentator + 文晶印章，h-14），favicon/apple-touch-icon 用 JW 单标（`public/images/brand/`，favicon 404 遗留项解决）
