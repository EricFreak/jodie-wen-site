...
**项目处于设计阶段，尚未开始实现。** 仓库当前唯一的内容是设计规格文档：

- `docs/superpowers/specs/2026-07-20-jodie-wen-personal-site-design.md` —— 已获用户批准的完整设计规格（目标、技术栈、架构、视觉、验证方案）。

尚无 `package.json`、`astro.config`、源码目录或 git 仓库。下述技术栈、目录结构与命令均为**规格中确定的方案**，实现时应以该规格文档为准；规格与本文如有出入，以规格文档为准。
